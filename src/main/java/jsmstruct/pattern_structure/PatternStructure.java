...
//		printLattice();
		...
		for (int candidate : generatorParents) {
			if (!intent.desc
				...
				Description intersection = intent.intersect(conceptList
	...
	public static void main(String[] args) {
		...
		Description desc5 = new Description(new ArrayList(Arrays.asList(
				Arrays.asList(0.63, 0.63), Arrays.asList(0.63, 0.63),
				Arrays.asList(0.02, 0.02), Arrays.asList(0.63, 0.63))));
		Description desc6 = new Description(new ArrayList(Arrays.asList(
				Arrays.asList(0.56, 0.56), Arrays.asList(0.72, 0.72),
				Arrays.asList(-0.06, -0.06), Arrays.asList(0.64, 0.64))));
		Description desc7 = new Description(new ArrayList(Arrays.asList(
				Arrays.asList(0.55, 0.55), Arrays.asList(0.62, 0.62),
				Arrays.asList(-0.03, -0.03), Arrays.asList(0.81, 0.81))));
		Description desc8 = new Description(new ArrayList(Arrays.asList(
				Arrays.asList(0.71, 0.71), Arrays.asList(0.62, 0.62),
				Arrays.asList(0.12, 0.12), Arrays.asList(0.66, 0.66))));
